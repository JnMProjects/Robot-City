...
function Skeleton({
  ...
  return (
    <div className=''>
      ...
      <div className="bg-l-bg dark:bg-d-bg relative z-50" style={{ top: `-${height}px`}}>
        <div
          className={cn("animate-skeletal-shine rounded-sm bg-l-bg-300 dark:bg-d-bg-800 ", className)}
